...
\item $[$: save position and angle, turn left 45 degrees
\item $]$: load position and angle, turn right 45 degrees
\end{itemize}
...
\item ‚ÄNothing elseÄù (generally implicit): Nothing is in the set of Pythagoras tree unless it is obtained from the base case and constructor rule.
\end{itemize}
\subsolution 
\begin{itemize}
\item axiom:	0
